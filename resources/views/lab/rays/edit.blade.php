          ...
          <div class="breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper mr-1">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('lab.rays.index')}}">@lang('admin.rays')</a>
                </li>
                <li class="breadcrumb-item active"><a href="#">@lang('admin.edit rays')</a>
                </li>
              </ol>
            </div>
          </div>
          ...
          <div class="card">
              ...
              <div class="card-content collapse show">
                  <div class="card-body">
                      ...
                      <form class="form" method="POST" action="{{ route('lab.rays.update', $rays->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                              ...
                              <select class="form-control round" max="100" id="name" name="category_id" required>
                                ...
                                <option @if ($rays->category_id == $category->id)   selected   @endif value="{{ $category->id }}">{{ $category->title }}</option>
                            ...
                            <div class="mb-3">
                              <label class="col-form-label pt-0" for="title"> @lang('admin.' . $locale . '.rays title')    </label>
                              <input class="form-control round" id="title" name="{{ $locale }}[title]" required value="{{$rays->translate($locale)->title }}" type="text">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control round"   id="price" name="price" required value="{{ $rays->price }}" type="number">
                            </div>
                          ...
                          <div class="form-actions">
                              <a href="{{ route('lab.rays.index') }}" type="button" class="btn btn-danger mr-1">
