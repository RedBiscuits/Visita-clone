          ...
          <div class="card">
              ...
              <div class="card-content collapse show">
                  <div class="card-body">
                      ...
                      <form action="{{ route('dashboard.doctors.update', $doctor->id) }}" method="POST" class="steps-validation" id="add-doctor" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                          ...
                          <fieldset>
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <select  name="department_id" class="form-control round" id="department_id" >
                                            <option disabled> @lang('admin.choose') </option>

                                            @foreach ($departments as $item)

                                                <option @if ($doctor->department_id == $item->id) selected
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <select    name="hospital_id" class="form-control round" id="hospital" >
                                            ...
                                            <option @if ( $doctor->hospital_id == $hospital->id) selected
                              ...
                              <div class="mb-3">
                                ...
                                <input required class="form-control round required" id="name" name="{{ $locale }}[name]" required
                                value="{{ $doctor->translate($locale)->name }}" type="text">
                              ...
                              <div class="mb-3">
                                ...
                                <textarea required class="form-control round" id="about" name="{{ $locale }}[about]" required>{{ $doctor->translate($locale)->about }}</textarea>
                              ...
                              <div class="form-group">
                                <fieldset class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input round" id="inputGroupFile01" name="image">
                              ...
                              <div class="col-md-6">
                                <img class="img-thumbnail img-fluid" src="{{ $doctor->image }}" style="height: 110px;" />
                              </div>
                            </div>
                          </fieldset>
                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input name="phone" required value="{{ $doctor->phone }}" type="text" class="form-control round" id="proposalTitle2" >
                                      </div>
                                      <div class="form-group">
                                          <label for="password"> @lang('admin.password')</label>
                                          <input type="password" name="password" class="form-control round" id="password" >
                                      </div>
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input type="email" required name="email" value="{{ $doctor->email }}" class="form-control round" id="email" >
                                      </div>
                                      <div class="form-group">
                                        <label for="password_confirmation"> @lang('admin.password_confirm')</label>
                                        <input type="password"   name="password_confirmation" class="form-control round" id="password_confirmation" >
                                    </div>
                                  </div>
                              </div>
                          </fieldset>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                   ...
                                   <tbody>
                                      ...
                                      @foreach($workinghours as $index=> $a)
                                      <tr>
                                        <td> {{ $index + 1 }} </td>
                                         <td><input type="hidden" required name="day[]" id="day{{$i}}" readonly="" value="{{$i}}" class="form-control" />
                                            <span>{{ $arr[$a->day]}}</span>
                                         </td>
                                         <td><input type="time" required name="from[]" id="from{{$i}}" class="form-control round" value="{{ $a->from }}"  /></td>
                                         <td><input type="time" required name="to[]" id="to{{$i}}" value="{{ $a->to }}" class="form-control round" onchange="checktime(this.value,'{{$i}}')"  /></td>
                                      </tr>
                                      <?php $i++; ?>
                                      @endforeach
                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="facebook" value="{{ $doctor->facebook }}" class="form-control round" id="meetingName2" >
                                      </div>

                                      <div class="form-group">
                                          <label for="meetingLocation2">@lang('admin.twitter')</label>
                                          <input type="text" name="twitter" value="{{ $doctor->twitter }}" class="form-control round" id="meetingLocation2" >
                                      </div>
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="linkedin" value="{{ $doctor->linkedin }}" class="form-control round" id="meetingLocation2" >
                                      </div>

                                      <div class="form-group">
                                        <label for="participants2">@lang('admin.youtube')</label>
                                        <input type="text" name="youtube" value="{{ $doctor->youtube }}" class="form-control round" id="meetingLocation2" >
                                    </div>
                                  </div>
                              </div>
                          </fieldset>
