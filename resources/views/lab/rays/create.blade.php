          ...
          <div class="breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper mr-1">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">@lang('admin.add rays')</a>
                </li>
              </ol>
            </div>
          </div>
          ...
          <div class="card">
              ...
              <div class="card-content collapse show">
                  <div class="card-body">
                      ...
                      <form class="form" method="POST" action="{{ route('lab.rays.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control round"   id="price" name="price" required value="{{ old('price') }}" type="number">
                            </div>
