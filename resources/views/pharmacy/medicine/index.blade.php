                  ...
                  <div class="card-body card-dashboard">
                      ...
                      <div class="table-responsive">
                          <table class="table table-striped table-bordered zero-configuration">
                              ...
                              <tbody>
                                @foreach ($medicines as $index => $dep)
                                  ...
                                  <tr>
                                      ...
                                      <td>{{ $dep->price }}</td>
                                       <td>{{ $dep->category->title }}</td>
                                      <td>{{ $dep->orders->count() }}</td>
                                        <td>
                                            <div class="btn-group mr-1 mb-1" >
                                                ...
                                                <div class="dropdown-menu"  x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(101px, 41px, 0px);">
                                                     <a class="dropdown-item" href="{{ route('pharmacy.medicine.edit',  $dep->id) }}" ><i class="ft-edit"></i> @lang('admin.edit')</a>
                                                    <div class="dropdown-divider" ></div>
                                                    <form method="POST" action="{{ route('pharmacy.medicine.destroy',  $dep->id) }}">
                                                        @csrf
                                                        @method('DELETE')
