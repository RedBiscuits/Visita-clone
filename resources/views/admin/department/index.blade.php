...
<div class="app-content content">
    <div class="content-wrapper">
      ...
      <a href="{{ route('dashboard.department.create') }}"   class="mr-1 mb-1 btn btn-outline-info   float-end" style="float: inline-end;"> <i class="fas fa-plus"></i> @lang('admin.add new')</a>
      </div>
                                      ...
                                      <td>
                                        <div class="btn-group mr-1 mb-1" bis_skin_checked="1">
                                            ...
                                            <div class="dropdown-menu" bis_skin_checked="1" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(101px, 41px, 0px);">
                                                 <a class="dropdown-item" href="{{ route('dashboard.department.edit',  $dep->id) }}" bis_skin_checked="1"><i class="ft-edit"></i> @lang('admin.edit')</a>
                                                <div class="dropdown-divider" bis_skin_checked="1"></div>
                                                <form method="POST" action="{{ route('dashboard.department.destroy',  $dep->id) }}">
                                                    @csrf
                                                    @method('DELETE')
