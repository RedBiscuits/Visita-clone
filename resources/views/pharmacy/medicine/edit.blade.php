          ...
          <div class="breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper mr-1">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">@lang('admin.edit medicine')</a>
                </li>
              </ol>
            </div>
          </div>
          ...
          <div class="card">
              ...
              <div class="card-content collapse show">
                  <div class="card-body">
                      ...
                      <form class="form" method="POST" action="{{ route('pharmacy.medicine.update', $medicine->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                          ...
                          <div class="form-body">
                            ...
                            <div class="mb-2">
                                ...
                                <select class="form-control round" max="100" id="name" name="category_id" required>
                                  ...
                                  <option @if ($medicine->category_id == $category->id) selected  @endif value="{{ $category->id }}">{{ $category->title }}</option>
                              ...
                              <div class="mb-2">
                                ...
                                <input class="form-control round" id="title" name="{{ $locale }}[title]" required value="{{ $medicine->translate($locale)->title }}" type="text">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control round" id="content" name="{{ $locale }}[content]" required   type="text">{{ $medicine->translate($locale)->content }}</textarea>
                            ...
                            <div class="mb-2">
                              ...
                              <input class="form-control round" id="price" required name="price" required value="{{ $medicine->price }}" type="text">
