    ...
    <div class="content-wrapper">
      ...
      <div class="content-header row">
        <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">@lang('admin.patients')</h3>
        </div>
      </div>
                                      ...
                                      <td>
                                        <div class="btn-group mr-1 mb-1" >
                                            ...
                                            <div class="dropdown-menu"  x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(101px, 41px, 0px);">
                                                <a class="dropdown-item" href="{{ route('dashboard.patient.show',  $dep->id) }}" ><i class="ft-eye"></i> @lang('admin.view')</a>
                                                {{--  <a class="dropdown-item" href="{{ route('dashboard.patient.edit',  $dep->id) }}" ><i class="ft-edit"></i> @lang('admin.edit')</a>  --}}
                                                <div class="dropdown-divider" ></div>
                                                <form method="POST" action="{{ route('dashboard.patient.destroy',  $dep->id) }}">
                                                    @csrf
                                                    @method('DELETE')
