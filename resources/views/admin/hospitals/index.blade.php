...
<div class="app-content content">
    <div class="content-wrapper">
      ...
      <a  href="{{ route('dashboard.hospitals.create') }}" class="mr-1 mb-1 btn btn-outline-info  float-end" style="float: inline-end;"> <i class="fas fa-plus"></i> @lang('admin.add new')</a>
      </div>
