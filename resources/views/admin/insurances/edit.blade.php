          ...
          <div class="card">
              ...
              <div class="card-content collapse show">
                  <div class="card-body">
                      ...
                      <form class="form" method="POST" action="{{ route('dashboard.insurance.update', $insurance->id) }}" enctype="multipart/form-data">
                        ...
                        @method('PUT')
                          ...
                          <div class="form-body">
                            ...
                            <div class="mb-3">
                              ...
                              <input class="form-control round" id="name" name="{{ $locale }}[title]" required value="{{  $insurance->translate($locale)->title }}" type="text">
                            ...
                            <div class="form-group">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control round" id="discount" name="discount" required value="{{ $insurance->discount }}" type="number">
