          ...
          <div class="breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper mr-1">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">@lang('admin.update pharmacy')</a>
                </li>
              </ol>
            </div>
          </div>
          ...
          <div class="card">
              ...
              <div class="card-content collapse show">
                  <div class="card-body">
                      ...
                      <form class="form" method="POST" action="{{ route('dashboard.pharmacy.update', $pharmacy->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                          ...
                          <div class="form-body">
                            ...
                            <div class="mb-3">
                              ...
                              <input class="form-control round" id="name" required name="name" required value="{{ $pharmacy->name }}" type="text">
                            ...
                            <div class="mb-3">
                              ...
                              <input class="form-control round" id="email" required name="email" required value="{{ $pharmacy->email }}" type="email">
                            ...
                            <div class="mb-3">
                              ...
                              <input class="form-control round" id="phone" required name="phone" required value="{{ $pharmacy->phone }}" type="number">
                            ...
                            <div class="mb-3">
                              ...
                              <input class="form-control round" id="address" required name="address" required  value="{{ $pharmacy->address }}"  type="text">
