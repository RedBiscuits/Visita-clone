    ...
    <div class="content-wrapper">
      ...
      <div class="content-header row">
        <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">@lang('admin.hospitals')</h3>
          <div class="breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper mr-1">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard.')}}">@lang('admin.home')</a>
                </li>
                <li class="breadcrumb-item"><a href="{{ route('dashboard.hospitals.index')}}">@lang('admin.hospitals')</a>
                </li>
                <li class="breadcrumb-item active"><a href="#">@lang('admin.add hospital')</a>
                </li>
              </ol>
            </div>
          </div>
          ...
          <div class="card">
              ...
              <div class="card-content collapse show">
                  <div class="card-body">
                      ...
                      <form class="form" method="POST" action="{{ route('dashboard.hospitals.store') }}" enctype="multipart/form-data">
                        @csrf
                          ...
                          <div class="form-body">
                            ...
                            <div class="mb-3">
                              <label class="col-form-label pt-0" for="name"> @lang('admin.' . $locale . '.hospital title')    </label>
                          ...
                          <div class="form-actions">
                              <a href="{{ route('dashboard.hospitals.index') }}" type="button" class="btn btn-danger mr-1">
