            ...
            <div class="breadcrumb-wrapper mr-1">
              <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="{{ route('pharmacy.')}}">@lang('admin.home')</a>
                </li>
          ...
          <div class="card">
              ...
              <div class="card-content collapse show">
                  <div class="card-body">
                    ...
                    <form class="form" method="POST" action="{{ route('pharmacy.profile.update') }}" enctype="multipart/form-data">
                        @csrf
          ...
          <div class="card">
              ...
              <div class="card-content">
                  <div class="card-body">
                      ...
                      <form class="form" method="POST" action="{{ route('pharmacy.updatepassword') }}">
                        @csrf
