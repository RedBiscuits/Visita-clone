          ...
          <div class="card">
              <div class="card-content collapse show">
                  <div class="card-body">
                      ...
                      <form class="form" method="POST" action="{{ route('dashboard.hospitals.update', $hospital->id) }}" enctype="multipart/form-data">
                        ...
                        @method('PUT')
                          ...
                          <div class="form-body">
                            ...
                            <div class="mb-3">
                              ...
                              <input class="form-control round" id="name" name="{{ $locale }}[title]" required value="{{  $hospital->translate($locale)->title }}" type="text">
