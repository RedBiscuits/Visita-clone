          ...
          <div class="breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper mr-1">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('dashboard.productcategory.index')}}">@lang('admin.productcategorys')</a>
                </li>
                <li class="breadcrumb-item active"><a href="#">@lang('admin.add productcategory')</a>
                </li>
              </ol>
            </div>
          </div>
          ...
          <div class="card">
              ...
              <div class="card-content collapse show">
                  <div class="card-body">
                      ...
                      <form class="form" method="POST" action="{{ route('dashboard.productcategory.store') }}" enctype="multipart/form-data">
                        @csrf
