          ...
          <div class="breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper mr-1">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">@lang('admin.edit offer')</a>
                </li>
              </ol>
            </div>
          </div>
          ...
          <div class="card">
              ...
              <div class="card-content collapse show">
                  <div class="card-body">
                      ...
                      <form class="form" method="POST" action="{{ route('dashboard.offers.update', $offer->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                              ...
                              <select class="form-control round" max="100" id="name" name="doctor_id" required>
                                ...
                                @foreach ($doctors as $doctor)
                                 ...
                                 <option @if ($offer->doctor_id == $doctor->id) selected @endif value="{{ $doctor->id }}">{{ $doctor->name }}</option>
                            ...
                            <div class="mb-3">
                              ...
                              <input class="form-control round" id="title" name="{{ $locale }}[title]" required value="{{ $offer->translate($locale)->title }}" type="text">
                            ...
                            <div class="mb-3">
                              ...
                              <textarea class="form-control round" id="content" name="{{ $locale }}[content]" required   type="text">{{ $offer->translate($locale)->content }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control round" max="100" id="name" name="discount" required value="{{ $offer->discount }}" type="number">
                            </div>

                            <div class="mb-3">
                                <label class="col-form-label pt-0" for="name"> @lang('admin.image')    </label>
                                <input class="form-control round"   id="name" name="image"     type="file">
                            </div>
