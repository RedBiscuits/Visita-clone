...
<div class="app-content content">
    <div class="content-wrapper">
      ...
      <a  href="{{ route('dashboard.offers.create') }}" class="mr-1 mb-1 btn btn-outline-info  float-end" style="float: inline-end;">
        <i class="fas fa-plus"></i> @lang('admin.add new')</a>
      </div>
                      ...
                      <div class="table-responsive">
                          <table class="table table-striped table-bordered zero-configuration">
                              ...
                              <tbody>
                                ...
                                @foreach ($offers as $index => $hospital)

                                  <tr>
                                      <td>{{ $index + 1  }}</td>
                                      <td>{{ $hospital->doctor->name }}</td>
                                      ...
                                      <td>
                                        <div class="btn-group mr-1 mb-1" >
                                            ...
                                            <div class="dropdown-menu"  x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(101px, 41px, 0px);">
                                                 <a class="dropdown-item" href="{{ route('dashboard.offers.edit',  $hospital->id) }}" ><i class="ft-edit"></i> @lang('admin.edit')</a>
                                                <div class="dropdown-divider" ></div>
                                                <form method="POST" action="{{ route('dashboard.offers.destroy',  $hospital->id) }}">
                                                    @csrf
                                                    @method('DELETE')
