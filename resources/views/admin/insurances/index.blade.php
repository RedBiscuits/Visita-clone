    ...
    <div class="content-wrapper">
      ...
      <div class="content-header row">
        <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">@lang('admin.insurances')</h3>
        </div>

        <div class="content-header-right col-md-4 breadcrumb-new">
            <a  href="{{ route('dashboard.insurance.create') }}" class="mr-1 mb-1 btn btn-outline-info  float-end" style="float: inline-end;"> <i class="fas fa-plus"></i> @lang('admin.add new')</a>
        </div>
                              ...
                              <tbody>
                                ...
                                @foreach ($insurances as $index => $insurance)
                                  ...
                                  <tr>
                                      ...
                                      <td><img src="{{ $insurance->image }}" class="img-fluid" width="100"> </td>
                                      <td>   {{ $insurance->discount }} % </td>
                                      <td> 0 </td>
                                      <td> 0 </td>
                                        <td>
                                            @if ($insurance->is_success == 1)
                                      ...
                                      <td>
                                        <div class="btn-group mr-1 mb-1" >
                                            ...
                                            <div class="dropdown-menu"  x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(101px, 41px, 0px);">
                                                ...
                                                <a class="dropdown-item" href="{{ route('dashboard.insurance.edit',  $insurance->id) }}" ><i class="ft-edit"></i> @lang('admin.edit')</a>
                                                <div class="dropdown-divider" ></div>
                                                <form method="POST" action="{{ route('dashboard.insurance.destroy',  $insurance->id) }}">
                                                    @csrf
                                                    @method('DELETE')
